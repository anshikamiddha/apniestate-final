        ...
        <div className="w-full flex flex-wrap-reverse justify-between items-center">
          <div className="w-full md:w-1/2 px-2">
            ...
            <h1 className="font-bold text-4xl my-5 md:text-5xl lg:text-6xl">
              {t("heading")}{" "}
              <span className="font-playFair">Apni Estate</span>
            </h1>
            ...
            <div className="flex items-center">
              <Link
                href={"/properties"}
                className="px-6 py-4 font-medium text-sm rounded-full bg-primary-blue text-white"
              >
                {t("button")}
              </Link>
              <div className="ms-4">
